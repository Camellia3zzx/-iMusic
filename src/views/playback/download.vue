...
<!-- 标题 -->
<span class="wordtitle">MUSIC DOWNLOAD</span>
<!-- 搜索框 -->
<div class="Search"><input class="search" type="text"><button class="searchphoto"></button></div>
<!-- 管理音乐和多选 -->
<div>
  <button class="manage">全部播放</button>
  <button  @click="toggleBox" class="mutichoice">批量管理</button>
</div>
<span class="word3">已下载音乐</span>
<ul class="Upload">
...
.manage:active,.mutichoice:active{
